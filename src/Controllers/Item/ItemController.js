...
module.exports = {
    async store(req, res) {
        let novoItem  = { nome_item, preco, categoria, com_preparo, departamento, ex_dicas } = req.body,
    ...
    async update(req, res){
        let itemAtualizado  = { nome_item, preco, categoria, com_preparo, departamento, ex_dicas } = req.body,
